...
description: >-
  ...
  palette, editorial typography, and calm density. Tokens (colors, typography, spacing,
  components, shape language) are in references/DESIGN.md.
---

# Anthropic brand

Use when the user wants AI-product UI that feels like Anthropic, warm neutrals, restrained palette, editorial typography, and calm density.
...
- Anthropic publishes the Claude Code Skills spec. This skill captures observed design tokens from the public anthropic.com marketing site.
