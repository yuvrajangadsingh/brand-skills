...
description: >-
  ...
  feel like the Tailwind CSS website, a clean utility-first aesthetic with generous
  whitespace, sky/blue accents, and a system-sans typography. Tokens (colors, typography,
  spacing, components, shape language) are in references/DESIGN.md.
---

# Tailwind CSS brand

Use when the user is building a developer documentation, landing page, or UI that should feel like the Tailwind CSS website, a clean utility-first aesthetic with generous whitespace, sky/blue accents, and a system-sans typography.
...
- Tailwind CSS is open source (MIT). The design tokens captured here are observed from the public marketing site.
