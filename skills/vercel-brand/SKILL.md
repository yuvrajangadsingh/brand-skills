...
name: vercel-brand
description: >-
  Use when the user is building a developer or infrastructure product UI that should feel
  like Vercel, a black/white core with minimal accents, geist-style typography, generous
  whitespace, and sharp edges. Tokens (colors, typography, spacing, components, shape
  language) are in references/DESIGN.md.
---

# Vercel brand

Use when the user is building a developer or infrastructure product UI that should feel like Vercel, a black/white core with minimal accents, geist-style typography, generous whitespace, and sharp edges.
...
- Vercel publishes brand guidance at vercel.com/design. This skill captures observed design tokens from the public marketing site.
